...
import com.example.myapp.LandingActivity
import com.example.myapp.databinding.ActivityLoginBinding
import com.example.myapp.signup
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.loginButton.setOnClickListener {
            ...
            if (gender.isEmpty()) {
                ...
                binding.gender.error = "Please fill back"
                Toast.makeText(this, "Please fill back", Toast.LENGTH_SHORT).show()
                isValid = false
            }
